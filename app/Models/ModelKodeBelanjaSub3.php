...
class ModelKodeBelanjaSub3 extends Model
{
    public function getKodeBelanjaSub3($id){
        ...
        $builder->select('tb_kode_belanja_sub3.id, kode_belanja_sub2, id_kode_belanja_sub2, kode_belanja_sub3, nama_rekening_belanja_sub3, nama_rekening_belanja_sub2, jumlah_anggaran_belanja_sub3,nama_rekening_dasar, tahun_anggaran, kode_rek_dinas, kode_rek_urusan, kode_rek_bidang, kode_rek_program, kode_rek_kegiatan, kode_rek_unit');
    ...
    public function getSearchRekReferensi(){
        $db = db_connect();
        $builder = $db->table('tb_kode_belanja_sub2');
        $builder->select('tb_kode_belanja_sub2.id, kode_belanja_sub2, kode_belanja_sub1, nama_rekening_belanja_sub2, nama_rekening_dasar, tahun_anggaran, kode_rek_dinas, kode_rek_urusan, kode_rek_bidang, kode_rek_program, kode_rek_kegiatan, kode_rek_unit');
