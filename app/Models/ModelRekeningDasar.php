...
class ModelRekeningDasar extends Model
{
    public function getRekeningDasar($id)
    {
        ...
        if ($id != null) {
            # code...
            $builder->select('tb_rekening_dasar.id, 
            id_kode_dinas, id_kode_urusan, id_kode_bidang, id_kode_program, id_kode_kegiatan, id_kode_unit, 
            nama_rekening_dasar, kode_rek_dinas, kode_rek_urusan, kode_rek_bidang, kode_rek_program, kode_rek_kegiatan, kode_rek_unit, keterangan_rekening_dasar, tahun_anggaran, jumlah_anggaran_rekening_dasar, 
            id_kpa_ppk, id_pptk, id_bendahara');
