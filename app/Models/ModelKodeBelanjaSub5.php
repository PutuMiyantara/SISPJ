...
class ModelKodeBelanjaSub5 extends Model
{
    public function getKodeBelanjaSub5($id){
        ...
        $builder->select('tb_kode_belanja_sub5.id, kode_belanja_sub5, nama_rekening_belanja_sub5, jumlah_anggaran_belanja_sub5, kode_belanja_sub4, nama_rekening_belanja_sub4, id_kode_belanja_sub4, id_kode_belanja_sub3, id_kode_belanja_sub2, id_kode_belanja_sub1, id_rekening_dasar ,nama_rekening_dasar, tahun_anggaran');
