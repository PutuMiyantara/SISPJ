            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="#">PPTK</a></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <form method="POST" enctype="multipart/form-data" name="formPptk" ng-submit="submitData()">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-sm-12 mb-6 mb-sm-0">
                            <div class="col"><label>NIP PPTK</label></div>
                            <div class="col-sm-12 mb-6 mb-sm-0">
                                <div class="form-group row">
                                    <input type="text" class="form-control" name="nip_pptk" ng-model="nip_pptk"
                                        ng-required="false" ng-readonly="false">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 mb-6 mb-sm-0">
                            <div class="col"><label>Nama PPTK</label></div>
                            <div class="col-sm-12 mb-6 mb-sm-0">
                                <div class="form-group row">
