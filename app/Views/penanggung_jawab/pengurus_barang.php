<!-- Begin Page Content -->
<div class="container-fluid" ng-controller="PengurusBarang">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="<?= base_url('/penanggungjawab/pengurus_barang') ?>"
                class="btn btn-outline-info active">Pengurusbarang</a>
        </div>
        <div class="card-body">
            <div>
            ...
            <div class="table-responsive">
                ...
                <table datatable="ng" dt-options="vm.dtOptions" class="table table-bordered" width="100%"
                    cellspacing="0" ng-init="getPengurusBarang()">
                    <thead>
                        <tr>
                            <th style="width: 10px;">No</th>
                            <th>NIP Pengurus Barang</th>
                    ...
                    <tbody>
                        <tr ng-repeat="d in datas">
                            <td>{{ $index +1 }}</td>
                            <td>{{ d.nip_pengurus_barang }}</td>
                            <td>{{ d.nama_pengurus_barang }}</td>
    ...
    <!-- Modal -->
    <div class="modal fade" tabindex="1" role="dialog" id="pengurus_barang">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form method="POST" enctype="multipart/form-data" name="formPengurusBarang" ng-submit="submitData()">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-sm-12 mb-6 mb-sm-0">
                            <div class="col"><label>NIP Pengurus Barang</label></div>
                            <div class="col-sm-12 mb-6 mb-sm-0">
                                <div class="form-group row">
                                    <input type="text" class="form-control" name="nip_pengurus_barang"
                                        ng-model="formModel.nip_pengurus_barang" ng-required="false"
                                        ng-readonly="false">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 mb-6 mb-sm-0">
                            <div class="col"><label>Nama Pengurus Barang</label></div>
                            <div class="col-sm-12 mb-6 mb-sm-0">
                                <div class="form-group row">
                                    <input type="text" class="form-control" name="nama_pengurus_barang"
                                        ng-model="formModel.nama_pengurus_barang" ng-required="false"
                                        ng-readonly="false">
                                </div>
                            </div>
                        </div>
