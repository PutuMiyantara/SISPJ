<!-- Begin Page Content -->
<div class="container-fluid" ng-controller="Kuwitansi">
    ...
    <section class=" content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Data Kuwitansi</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Kuwitansi</a></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <table datatable="ng" dt-options="vm.dtOptions" class="table table-bordered" width="100%"
                    cellspacing="0" ng-init="getKuwitansi()">
                    <thead>
                        <tr>
                            <th style="width: 10px;">No</th>
                            <th>No Kuwitansi</th>
                            <th>Tanggal Kuwitansi</th>
                            <th>Rekening Dasar</th>
                            <th>Rekening Belanja</th>
                            <th>Uraian Belanja</th>
                            <th>Dasar SPJ (Bukti)</th>
                            <th>Penerima Uang</th>
                            <th>Instansi</th>
                            <th>Keterangan SPJ</th>
                            <th>Status SPJ</th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        <tr ng-repeat="d in datas">
                            <td>{{ $index +1 }}</td>
                            <td>{{ d.no_kuwitansi }}</td>
                            <td>{{ d.tgl_kuwitansi }}</td>
                            <td>{{ 
                                d.kode_rek_dinas + "." +
                                d.kode_rek_urusan + "." +
                                d.kode_rek_bidang + "." +
