...
<div class="container-fluid" ng-controller="KodeUrusan">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="#">Kode Rekening Urusan</a></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="<?= base_url('/rekdasar/urusan') ?>" class="btn btn-outline-info active">Kode Urusan</a>
                ...
                <form method="POST" enctype="multipart/form-data" name="formKodeUrusan" ng-submit="submitData()">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger col-sm-3 mb-6"
                            ng-click="closeModal('#kodeUrusan')">Kembali</button>
                    </div>
                </form>
            </div>
        </div>
