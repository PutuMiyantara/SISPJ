...
<div class="container-fluid" ng-controller="KodeUnit">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Data Kode Rekening Unit</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Rekening Dasar</a></li>
                        <li class="breadcrumb-item active"><a href="#">Kode Rekening Unit</a></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <table datatable="ng" dt-options="vm.dtOptions" class="table table-bordered" width="100%"
                    cellspacing="0" ng-init="getKodeUnit()">
                    <thead>
                        <tr>
    ...
    <!-- Modal -->
    <div class="modal fade" tabindex="1" role="dialog" id="kodeUnit">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form method="POST" enctype="multipart/form-data" name="formKodeUnit" ng-submit="submitData()">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-sm-12 mb-6 mb-sm-0">
                            ...
                            <div class="col-sm-12 mb-6 mb-sm-0">
                                <div class="form-group row">
                                    <textarea class="form-control" name="nama_rek_unit" ng-model="nama_rek_unit"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger col-sm-2 mb-3" ng-click="closeModal('#kodeUnit')"><i
