...
<!-- Begin Page Content -->
<div class="container-fluid" ng-controller="KodeBelanjaSub2">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="#">Kode Rekening Belanja Sub 2</a></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <table datatable="ng" dt-options="vm.dtOptions" class="table table-bordered" width="100%"
                    cellspacing="0" ng-init="getKodeBelanjaSub2()">
                    <thead>
                        <tr>
                        ...
                        <div class="col-sm-12 mb-6 mb-sm-0">
                            ...
                            <div class="col-sm-12 mb-6 mb-sm-0">
                                <div class="form-group row">
                                    <input type="text" class="form-control" name="kode_belanja_sub2"
                                        ng-model="formModel.kode_belanja_sub2" ng-required="false" ng-readonly="false">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 mb-6 mb-sm-0">
                            ...
                            <div class="col-sm-12 mb-6 mb-sm-0">
                                <div class="form-group row">
                                    <input class="form-control" name="nama_rekening_belanja_sub2"
                                        ng-model="formModel.nama_rekening_belanja_sub2" ng-required="false"
                                        ng-readonly="false">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12 mb-6 mb-sm-0">
                                <div class="form-group row">
                                    <input class="form-control" name="jumlah_anggaran_belanja_sub2"
                                        ng-model="formModel.jumlah_anggaran_belanja_sub2" ng-required="false"
                                        ng-readonly="false">
                                </div>
                            </div>
                        </div>
