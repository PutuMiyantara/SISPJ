...
<div class="container-fluid" ng-controller="KodeBelanjaSub4">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="<?= base_url('/rekbelanja/kodesub4') ?>" class="btn btn-outline-info active">Kode Sub 4</a>
                        ...
                        <tr ng-repeat="d in datas">
                            ...
                            <td style="text-align: center;">
                                <button type="submit" class="btn btn-info"
                                    ng-click="getDetail(d.id, d.id_rekening_dasar, d.id_kode_belanja_sub1, d.id_kode_belanja_sub2)"><i
