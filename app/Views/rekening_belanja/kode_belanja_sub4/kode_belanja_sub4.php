...
<!-- Begin Page Content -->
<div class="container-fluid" ng-controller="KodeBelanjaSub4">
    ...
    <section class=" content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Data Kode Rekening Belanja Sub 4</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Rekening Belanja</a></li>
                        <li class="breadcrumb-item"><a href="#">Kode Rekening Belanja Sub 4</a></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
                ...
                foreach ($dataUrl as $main) {
                    ...
                    foreach ($main['sub_menu'] as $sub) {
                        ...
                        foreach ($sub['subsub_menu'] as $subsub) {
                            # code...
                            if (preg_replace("/[^a-zA-Z0-9\']/", "", $subsub['sub_sub_url']) == $uri->getSegment(2)) {
            ...
            <a href="<?= base_url($sub['sub_url'].$subsub['sub_sub_url'].$kategori['kategori_url'])?>" class="btn btn-outline-info 
                    <?php if ($uri->getSegment(3) == preg_replace("/[^a-zA-Z0-9\']/", "", $kategori['kategori_url'])): echo 'active'; 
                    else: ''; endif ?>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <table datatable="ng" dt-options="vm.dtOptions" class="table table-bordered" width="100%"
                    cellspacing="0" ng-init="getKodeBelanjaSub4()">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr ng-repeat="d in datas">
                            <td>{{ $index +1 }}</td>
                            <td>{{ d.kode_belanja_sub4 }}</td>
                            <td>{{ d.nama_rekening_belanja_sub4 }}</td>
                            <td>Rp. {{ d.jumlah_anggaran_belanja_sub4 }}</td>
                            <td>{{ d.kode_belanja_sub3 + " - " + d.nama_rekening_belanja_sub3 }}</td>
                            <td>{{ 
                                d.kode_rek_dinas + "." +
                                d.kode_rek_urusan + "." +
                                d.kode_rek_bidang + "." +
    ...
    <!-- Modal -->
    <div class="modal fade" role="dialog" role="dialog" aria-hidden="true" id="kodeBelanjaSub4">
                ...
                <form method="POST" enctype="multipart/form-data" name="formKodeDinas" ng-submit="submitData()">
                        ...
                        <div class="col-sm-12 mb-6 mb-sm-0">
                            ...
                            <div class="col-sm-12 mb-6 mb-sm-0">
                                <div class="form-group row">
                                    <input type="text" class="form-control" name="kode_belanja_sub4"
                                        ng-model="formModel.kode_belanja_sub4" ng-required="false" ng-readonly="false">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 mb-6 mb-sm-0">
                            ...
                            <div class="col-sm-12 mb-6 mb-sm-0">
                                <div class="form-group row">
                                    <input class="form-control" name="nama_rekening_belanja_sub4"
                                        ng-model="formModel.nama_rekening_belanja_sub4" ng-required="false"
                                        ng-readonly="false">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 mb-6 mb-sm-0">
                            <div class="col"><label>Jumlah Anggaran Belanja Sub 4</label></div>
                            <div class="col-sm-12 mb-6 mb-sm-0">
                                <div class="form-group row">
                                    <input class="form-control" name="jumlah_anggaran_belanja_sub4"
                                        ng-model="formModel.jumlah_anggaran_belanja_sub4" ng-required="false"
                                        ng-readonly="false">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger col-sm-2 mb-3"
                            ng-click="closeModal('#kodeBelanjaSub4')"><i class="fa fa-right-from-bracket"></i>
                            Kembali</button>
                    </div>
                </form>
            </div>
