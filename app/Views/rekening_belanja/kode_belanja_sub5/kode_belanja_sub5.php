...
<div class="container-fluid" ng-controller="KodeBelanjaSub5">
    ...
    <section class=" content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Data Kode Rekening Belanja Sub 5</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Rekening Belanja</a></li>
                        <li class="breadcrumb-item"><a href="#">Kode Rekening Belanja Sub 5</a></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="<?= base_url('/rekbelanja/kodesub5') ?>" class="btn btn-outline-info active">Kode Sub 5</a>
        </div>
        <div class="card-body">
            <div>
                ...
                <table datatable="ng" dt-options="vm.dtOptions" class="table table-bordered" width="100%"
                    ...
                    <tbody>
                        <tr ng-repeat="d in datas">
                            <td>{{ $index +1 }}</td>
                            <td>{{ d.kode_belanja_sub5 }}</td>
                            <td>{{ d.nama_rekening_belanja_sub5 }}</td>
                            <td>Rp. {{ d.jumlah_anggaran_belanja_sub5 }}</td>
                            <td>{{ d.kode_belanja_sub4 + " - " + d.nama_rekening_belanja_sub4 }}</td>
                            <td>{{ 
                                d.kode_rek_dinas + "." +
                                d.kode_rek_urusan + "." +
                                d.kode_rek_bidang + "." +
