...
<body id="page-top" ng-app="sispj">
    ...
    <div id="wrapper">
        ...
        <ul class=" navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <?php 
            if (!is_null($main['sub_menu'])) :
                # code...
                foreach ($main['sub_menu'] as $sub) :
                    # code...
            ?>
            <li class="nav-item active">
                <a class=" nav-link collapsed" href="#" data-toggle="collapse" data-target="#rekdasarmenu"
                    aria-expanded="true" aria-controls="rekdasarmenu">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Master Data</span>
                </a>
                <div id="rekdasarmenu" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">--Pilihan--</h6>
                        <a class="collapse-item" href="/rekdasar/">Data Rekening Dasar</a>
                        <a class="collapse-item" href="/rekbelanja">Data Rekening Belanja</a>
                        <a class="collapse-item" href="/user">User</a>
                        <a class="collapse-item" href="/penanggungjawab/kpa_ppk">Penanggung Jawab Anggaran</a>
                    </div>
                </div>
            </li>
            <?php
